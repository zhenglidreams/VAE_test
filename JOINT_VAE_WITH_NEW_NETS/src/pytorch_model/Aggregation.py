...
# ROUND 99:
# X sizes: [torch.Size([1, 26, 96, 90]), torch.Size([1, 30, 106, 49]), torch.Size([1, 22, 30, 77])]
# add_pad_cst torch.Size([1, 30, 106, 90])
# add_pad_ref torch.Size([1, 30, 106, 90])
# add_pad_rep torch.Size([1, 30, 106, 90])
# add_inter_near torch.Size([1, 30, 106, 90])
# add_inter_bilin torch.Size([1, 30, 106, 90])
# cat_pad_cst torch.Size([1, 78, 106, 90])
# cat_pad_ref torch.Size([1, 78, 106, 90])
# cat_pad_rep torch.Size([1, 78, 106, 90])
# cat_inter_near torch.Size([1, 78, 106, 90])
# cat_inter_bilin torch.Size([1, 78, 106, 90])
